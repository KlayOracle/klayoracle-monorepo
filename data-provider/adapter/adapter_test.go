...
func TestAdapterMarshalOk(t *testing.T) {
	...
	byt := []byte(`
				...
				"name": "KLAY_USD",
				"job_type": "DATA_FEED",
				"adapter_id":"8b7460cccfa0aca303ee85c3fb81c344faad2fbab415adc32b2984008b7efd76",
	...
	assert.Equal(t, newAdapter.AdapterId, "8b7460cccfa0aca303ee85c3fb81c344faad2fbab415adc32b2984008b7efd76")
