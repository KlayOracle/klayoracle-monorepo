...
class Trace {
    ...
    checkForErrors(allowedCodes = { compute: [], action: [], contracts: { any: { compute: [], action: [] } } }) {
        ...
        if (!skipComputeCheck && tx && tx.compute.exit_code !== 0) {
            ...
            if ((0, utils_1.isErrorExistsInAllowedArr)(allowedCodes.compute, tx.compute.exit_code) ||
                (0, utils_1.isErrorExistsInAllowedArr)(allowedCodes.contracts?.[this.msg.dst]?.compute, tx.compute.exit_code)) {
            ...
            // we didnt expect this error, save error
            if ((0, utils_1.isErrorExistsInAllowedArr)(allowedCodes.action, tx.action.result_code) ||
                (0, utils_1.isErrorExistsInAllowedArr)(allowedCodes.contracts?.[this.msg.dst]?.action, tx.action.result_code)) {
                this.error.ignored = true;
            }
        }
